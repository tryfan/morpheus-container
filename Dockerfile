...
RUN sed "s/^default.'morpheus_solo'..'check-server'..'enable'. = true/default['morpheus_solo']['check-server']['enable'] = false/" /opt/morpheus/embedded/cookbooks/morpheus-solo/attributes/default.rb
